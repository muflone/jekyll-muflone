...
installarli esplicitamente.
    ...
    sh-4.3# pacman -S dialog wpa_supplicant rfkill
    resolving dependencies...
    looking for conflicting packages...

    Packages (4) libnl-3.2.25-1  dialog-1:1.2_20150528-1  rfkill-0.5-1  wpa_supplicant-1:2.3-1
    ...
    (1/4) installing dialog                                    [####################################] 100%
    (2/4) installing libnl                                     [####################################] 100%
    (3/4) installing wpa_supplicant                            [####################################] 100%
    Optional dependencies for wpa_supplicant
        wpa_supplicant_gui: wpa_gui program
    (4/4) installing rfkill
